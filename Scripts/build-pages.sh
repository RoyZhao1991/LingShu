...
cp "$ROOT/Docs/media/lingshu-task-replay.mp4" "$OUTPUT/assets/lingshu-task-replay.mp4"
cp "$ROOT/Docs/media/lingshu-task-replay-poster.jpg" "$OUTPUT/assets/lingshu-task-replay-poster.jpg"
