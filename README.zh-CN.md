<div align="center">
  ...
  <p>
    ...
    <a href="https://github.com/RoyZhao1991/LingShu/releases/tag/v0.1.0-alpha.6"><img alt="最新版本" src="https://img.shields.io/github/v/release/RoyZhao1991/LingShu?include_prereleases&label=download"></a>
  </p>

  <p>
    <a href="https://royzhao1991.github.io/LingShu/"><strong>官方网站</strong></a>
    ·
    <a href="https://github.com/RoyZhao1991/LingShu/releases/tag/v0.1.0-alpha.6"><strong>下载已签名的 macOS Alpha</strong></a>
...
1. 从 [v0.1.0-alpha.6 Release](https://github.com/RoyZhao1991/LingShu/releases/tag/v0.1.0-alpha.6) 下载 DMG 与对应 `.sha256` 文件。
2. 在终端校验下载文件：
...
| 官网签名与公证发布 | [v0.1.0-alpha.6 已发布](https://github.com/RoyZhao1991/LingShu/releases/tag/v0.1.0-alpha.6) |
