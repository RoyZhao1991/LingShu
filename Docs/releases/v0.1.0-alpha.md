...
2. Verify the download with `shasum -a 256 -c LingShu-0.1.0-1-macOS-universal.dmg.sha256`.
...
2. 运行 `shasum -a 256 -c LingShu-0.1.0-1-macOS-universal.dmg.sha256` 校验文件。
