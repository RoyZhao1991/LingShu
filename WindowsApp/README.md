...
Prebuilt x64 preview installers are published at [windows-v0.1.0-preview.4](https://github.com/RoyZhao1991/LingShu/releases/tag/windows-v0.1.0-preview.4). The stable setup filename is [`Nous-Windows-x64-Setup.exe`](https://github.com/RoyZhao1991/LingShu/releases/download/windows-v0.1.0-preview.4/Nous-Windows-x64-Setup.exe).
